...
if (generatedFreshnessMode && policyOnlyMode) {
  fail("generated freshness and policy-only modes are mutually exclusive");
}
...
assertContains(".github/workflows/crates-release.yml", "preflight_run_id:");
assertContains(".github/workflows/crates-release.yml", "release_sha:");
assertContains(".github/workflows/crates-release.yml", "version:");
...
assertContains(".github/workflows/crates-release.yml", '.conclusion == "success"');
assertContains(".github/workflows/crates-release.yml", '.event == "workflow_dispatch"');
assertContains(".github/workflows/crates-release.yml", ".run_attempt == 1");
assertContains(".github/workflows/crates-release.yml", "preflight inputs do not match the requested release");
assertContains(
  ".github/workflows/crates-release.yml",
...
assertContains(
  ".github/workflows/crates-release.yml",
  "reallyme-cose-crates-preflight-${{ inputs.version }}-${{ inputs.release_sha }}",
);
...
assertContains(".github/workflows/crates-release.yml", "Swatinem/rust-cache@23869a5bd66c73db3c0ac40331f3206eb23791dc");
...
assertContains(
  ".github/workflows/crates-release.yml",
  "origin/main moved after preflight review; refusing publication",
);
...
assertContains(".github/workflows/release-preflight.yml", "BUF_VERSION: 1.71.0");
assertContains(".github/workflows/release-preflight.yml", "BUFFA_VERSION: 0.9.0");
assertContains(".github/workflows/release-preflight.yml", "CARGO_DENY_VERSION: 0.20.2");
assertContains(".github/workflows/release-preflight.yml", "CARGO_AUDIT_VERSION: 0.22.2");
assertContains(".github/workflows/release-preflight.yml", "CARGO_NEXTEST_VERSION: 0.9.140");
assertContains(".github/workflows/release-preflight.yml", "CARGO_CHECK_EXTERNAL_TYPES_VERSION: 0.5.0");
assertContains(".github/workflows/release-preflight.yml", "EXTERNAL_TYPES_NIGHTLY: nightly-2026-03-20");
assertContains(".github/workflows/release-preflight.yml", "WASM_PACK_VERSION: 0.15.0");
assertContains(".github/workflows/release-preflight.yml", "WASM_BINDGEN_CLI_VERSION: 0.2.126");
assertContains(".github/workflows/release-preflight.yml", "release_sha:");
assertContains(".github/workflows/release-preflight.yml", "version:");
assertContains(
  ".github/workflows/release-preflight.yml",
  "group: crates-preflight-${{ inputs.version }}-${{ inputs.release_sha }}",
);
assertContains(".github/workflows/release-preflight.yml", "runs-on: ubuntu-24.04");
assertNotContains(".github/workflows/release-preflight.yml", "runs-on: ubuntu-latest");
assertContains(".github/workflows/release-preflight.yml", "ref: ${{ inputs.release_sha }}");
assertContains(".github/workflows/release-preflight.yml", "fetch-depth: 0");
assertContains(".github/workflows/release-preflight.yml", 'if [[ "$GITHUB_SHA" != "$RELEASE_SHA" ]]');
assertContains(
  ".github/workflows/release-preflight.yml",
  "git fetch --force --no-tags origin main:refs/remotes/origin/main",
);
assertContains(".github/workflows/release-preflight.yml", "version does not match both publishable crate manifests");
assertContains(".github/workflows/release-preflight.yml", "actions/checkout@9c091bb21b7c1c1d1991bb908d89e4e9dddfe3e0");
assertContains(".github/workflows/release-preflight.yml", "actions/setup-node@820762786026740c76f36085b0efc47a31fe5020");
assertContains(".github/workflows/release-preflight.yml", "Swatinem/rust-cache@23869a5bd66c73db3c0ac40331f3206eb23791dc");
assertContains(
  ".github/workflows/release-preflight.yml",
  "actions/upload-artifact@043fb46d1a93c77aae656e7c1c64a875d1fc6a0a",
);
assertContains(".github/workflows/release-preflight.yml", "reallyme.cose.crates_preflight.v1");
assertContains(
  ".github/workflows/release-preflight.yml",
  "reallyme-cose-crates-preflight-${{ inputs.version }}-${{ inputs.release_sha }}",
);
assertContains(".github/workflows/release-preflight.yml", "node-version: '24'");
assertContains(".github/workflows/release-preflight.yml", "BUF_LINUX_X86_64_SHA256:");
assertContains(".github/workflows/release-preflight.yml", "sha256sum --check --strict");
...
assertContains(".github/workflows/release-preflight.yml", "taiki-e/install-action@43aecc8d72668fbcfe75c31400bc4f890f1c5853");
assertContains(".github/workflows/release-preflight.yml", 'protoc-gen-buffa --version "$BUFFA_VERSION"');
assertContains(".github/workflows/release-preflight.yml", 'protoc-gen-buffa-packaging --version "$BUFFA_VERSION"');
