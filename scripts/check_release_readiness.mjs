...
assertContains(
  ...
  "run-name: Crates.io release ${{ inputs.version }} @ ${{ inputs.release_sha }}",
);
assertContains(
  ".github/workflows/crates-release.yml",
...
assertContains(cratesPackagePreflightWorkflow, "actions/checkout@9c091bb21b7c1c1d1991bb908d89e4e9dddfe3e0");
assertContains(cratesPackagePreflightWorkflow, "actions/setup-node@820762786026740c76f36085b0efc47a31fe5020");
assertContains(cratesPackagePreflightWorkflow, "Swatinem/rust-cache@23869a5bd66c73db3c0ac40331f3206eb23791dc");
assertContains(
  cratesPackagePreflightWorkflow,
...
assertContains(cratesPackagePreflightWorkflow, "taiki-e/install-action@43aecc8d72668fbcfe75c31400bc4f890f1c5853");
