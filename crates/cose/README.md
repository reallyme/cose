...
[`docs/platform-scope-0.2.0.json`](https://github.com/reallyme/cose/blob/main/docs/platform-scope-0.2.0.json).
...
[`docs/performance-baseline-0.2.0.md`](https://github.com/reallyme/cose/blob/main/docs/performance-baseline-0.2.0.md).
