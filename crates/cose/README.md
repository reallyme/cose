...
[`docs/platform-scope-0.2.1.json`](https://github.com/reallyme/cose/blob/main/docs/platform-scope-0.2.1.json).
...
[`docs/performance-baseline-0.2.1.md`](https://github.com/reallyme/cose/blob/main/docs/performance-baseline-0.2.1.md).
